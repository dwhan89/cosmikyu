...
SDS_train = datasets.SehgalDataSet(sehgal_dir, "train281220_fromcat", transforms=[SDN, RF, SC], dummy_label=True,
                                   dtype=np.float64,
                                   shape=shape)
...
DCGAN_WGP = gan.DCGAN_WGP("sehgal_dcganwgp_281220", shape, latent_dim, nconv_fcgen=64,
                          nconv_fcdis=64, cuda=cuda, ngpu=4, nconv_layer_gen=5, nconv_layer_disc=5, kernal_size=4,
                          stride=2,
